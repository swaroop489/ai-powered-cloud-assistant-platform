    ...
    <div className="min-h-screen bg-white text-zinc-900 font-sans selection:bg-zinc-900 selection:text-white">
      ...
      <section className="max-w-5xl mx-auto px-6 text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 mb-16">
          <button className="px-8 py-4 bg-zinc-900 hover:bg-zinc-800 text-white rounded-lg font-medium transition-all flex items-center justify-center gap-2 shadow-lg shadow-zinc-500/20">
      ...
      <section className="border-t border-zinc-100 bg-zinc-50 py-24">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
            <button className="w-full sm:w-auto px-8 py-3 bg-zinc-900 text-white rounded-lg hover:bg-zinc-800 transition-all font-medium">
